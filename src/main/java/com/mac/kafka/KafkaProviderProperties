 ...
 */
@Configuration
@ConfigurationProperties(prefix = "kafka.provider")
@ConditionalOnProperty(name = "kafka.provider.enabled", havingValue = "true")
@Data
public class KafkaProviderProperties {
        @Value("${kafka.bootstrap-servers}")
        private String bootstrapServers;
        @Value("${kafka.provider.transaction-id-prefix}")
        private String transactionIdPrefix;
        @Value("${kafka.provider.acks}")
        private String acks;
        @Value("${kafka.provider.retries}")
        private String retries;
        @Value("${kafka.provider.batch-size}")
        private String batchSize;
        @Value("${kafka.provider.buffer-memory}")
